...
import type { FloatingTooltipOptions } from '@rui/add-ons/components/slider'
import { Slider } from '@rui/add-ons/components/slider'
...
<template>
  <div class="container flex flex-col items-center gap-4">
    <p class="test-block gap-2">
      ...
      <Button @click="tSliderPropsChange">
        Slider Props Change
      </Button>
    </p>
    <div class="w-full flex gap-4">
      <div class="flex-1 border border-hbb rounded p-2 flex flex-col gap-10">
        ...
        <div>
          <p class="pb-2">
            Teleport Floating Tooltip With Component:
          </p>
          <Slider
            v-model="sliderState"
            :contained="true"
        ...
        <div>
          ...
          >
            <template #dot>
              <div class="w-full h-full rounded-full bg-rz-green" />
            </template>
            <template #mark="{ pos }">
              <div
      ...
      <div class="flex-1 border border-hbb rounded p-2 flex flex gap-10">
        <div class="flex">
          <p class="pr-2" style="writing-mode: vertical-rl">
            Normal Tooltip:
          </p>
          <Slider
            v-model="sliderState"
